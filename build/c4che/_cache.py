...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-_wncS2/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-_wncS2/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-_wncS2/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-_wncS2/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['wireless', 'ipv6', 'udp', 'error-model', 'routing', 'matrix-topology', 'socket', 'udp-client-server', 'energy', 'tcp', 'realtime', 'stats', 'tutorial', 'traffic-control', 'naming']
...
NS3_EXECUTABLE_PATH = ['/home/yzqaveiro/eclipse-workspace/NS3/build/src/fd-net-device', '/home/yzqaveiro/eclipse-workspace/NS3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/yzqaveiro/eclipse-workspace/NS3/build/lib']
...
cfg_files = ['/home/yzqaveiro/eclipse-workspace/NS3/build/ns3/config-store-config.h', '/home/yzqaveiro/eclipse-workspace/NS3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
